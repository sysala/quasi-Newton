function [U, it, crit_hist,omega_hist]=newton_damped(U_ini,WEIGHT,K_fix,B,f,heter_int,alpha,beta)
                               
%--------------------------------------------------------------------------
% The semismooth Newton method for solution of the system 
%              find U:   F(U)=f
%
% Input data:

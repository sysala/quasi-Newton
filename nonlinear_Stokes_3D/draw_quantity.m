function draw_quantity(coord,surf,U,Q_node,elem_type,size_xy_0,size_xy_L,size_z)
...
%
 ...
 % undeformed shape of the body
  plot3([-size_xy_0/2,size_xy_0/2],[-size_xy_0/2,-size_xy_0/2],[0,0])
  plot3([-size_xy_L/2,size_xy_L/2],[-size_xy_L/2,-size_xy_L/2],[size_z,size_z])
  plot3([-size_xy_0/2,size_xy_0/2],[size_xy_0/2,size_xy_0/2],[0,0])
  plot3([-size_xy_L/2,size_xy_L/2],[size_xy_L/2,size_xy_L/2],[size_z,size_z])
  plot3([-size_xy_0/2,-size_xy_0/2],[-size_xy_0/2,size_xy_0/2],[0,0])
  plot3([-size_xy_L/2,-size_xy_L/2],[-size_xy_L/2,size_xy_L/2],[size_z,size_z])
  plot3([size_xy_0/2,size_xy_0/2],[-size_xy_0/2,size_xy_0/2],[0,0])
  plot3([size_xy_L/2,size_xy_L/2],[-size_xy_L/2,size_xy_L/2],[size_z,size_z])
  plot3([-size_xy_0/2,-size_xy_L/2],[-size_xy_0/2,-size_xy_L/2],[0,size_z])
  plot3([-size_xy_0/2,-size_xy_L/2],[size_xy_0/2,size_xy_L/2],[0,size_z])
  plot3([size_xy_0/2,size_xy_L/2],[-size_xy_0/2,-size_xy_L/2],[0,size_z])
  plot3([size_xy_0/2,size_xy_L/2],[size_xy_0/2,size_xy_L/2],[0,size_z])  

...
3) Build MATLAB MEX binding for BoomerAMG for nonlinear_Stokes_3D.
...
if [[ $DO_MEX -eq 1 ]]; then
  echo "MEX source built via: nonlinear_Stokes_3D/+LINEAR_SOLVERS/build_hypre_boomeramg_mex.m"
fi

function [U, it, crit_hist, omega_hist, itcg, timed_out] = newton_quasi1(U_ini,WEIGHT,K_elast,B,f,Q,mu_0,mu_infty,lambda,p,linear_system_solver,max_runtime_seconds)
    ...
    while true
        if toc(method_timer) >= max_runtime_seconds
            ...
            fprintf('     Quasi-Newton method 1 timed out after %.2f s', max_runtime_seconds)
            fprintf('\n');
            break
        end

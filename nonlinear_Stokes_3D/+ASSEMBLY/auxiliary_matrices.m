...
function [B,K_elast,WEIGHT]=auxiliary_matrices(ELEM,COORD,...
                                        mu_0,DHatP1,DHatP2,DHatP3,WF)
...
%             number of nodes
%    mu_0   - parameter mu_0 at integration points, size(mu_0)=(1,n_int)
...
%   
  ...
  ELAST=IDENT(:)*mu_0;   % size(ELAST)=(36,n_int)
  r=[1 8 15 22 29 36];
  iD=repmat(AUX,6,1); 
